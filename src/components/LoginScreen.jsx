...
export default function LoginScreen({ onRecoveryClick }) {
  ...
  return (
    <div className="relative overflow-hidden py-4 px-4 sm:py-8 sm:px-6 lg:py-14 lg:px-8 text-center min-h-0 overflow-y-auto">
      ...
      <div className="relative z-10">
        <div className="relative inline-block mb-3 sm:mb-4">
          ...
          <img
            ...
            className="h-28 w-28 sm:h-40 sm:w-40 md:h-[220px] md:w-[220px] rounded-full object-cover shadow-xl drop-shadow-2xl animate-logo-float"
          />
        </div>
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-wider uppercase bg-gradient-to-r from-sky-400 to-sky-600 bg-clip-text text-transparent mb-1">
          Frota do Atlântico
        </h1>
        ...
        <form onSubmit={handleLogin} className="w-full max-w-[380px] mx-auto mt-4 sm:mt-6 lg:mt-9 text-left px-1">
          ...
          <div
            ...
            className="mt-6 sm:mt-10 flex flex-col items-center gap-2 sm:gap-3 cursor-pointer min-h-[44px]"
